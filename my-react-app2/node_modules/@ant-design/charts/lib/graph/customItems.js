...
_es.default.registerNode('card-node', {
    ...
    if (cfg.children) {
      markerShape = group.addShape('marker', {
        attrs: {
          ...
          r: 6,
          cursor: 'pointer',
          symbol: cfg.collapsed ? _es.default.Marker.expand : _es.default.Marker.collapse,
          stroke: color,
          lineWidth: 1,
          fill: '#fff'
        },
...
_es.default.registerNode('round-rect', {
...
var customIconNode = function customIconNode(params) {
  _es.default.registerNode('icon-node', {
    options: {
      size: [60, 20],
      stroke: '#91d5ff',
      fill: '#91d5ff'
      ...
      if (params.enableEdit) {
        group.addShape('marker', {
          attrs: {
            ...
            stroke: '#73d13d',
            cursor: 'pointer',
            symbol: _es.default.Marker.expand
          },
          name: 'add-item'
        });
        group.addShape('marker', {
          attrs: {
            ...
            stroke: '#ff4d4f',
            cursor: 'pointer',
            symbol: _es.default.Marker.collapse
          },
          name: 'remove-item'
        });
      }
...
_es.default.registerEdge('fund-polyline', {
  draw: function draw(cfg, group) {
...
_es.default.registerEdge('flow-line', {
  draw: function draw(cfg, group) {
    var startPoint = cfg.startPoint;
    var endPoint = cfg.endPoint;
