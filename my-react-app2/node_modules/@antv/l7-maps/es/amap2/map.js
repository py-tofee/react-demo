...
var AMapService = (_dec = injectable(), _dec2 = inject(TYPES.IGlobalConfigService), _dec3 = inject(TYPES.ILogService), _dec4 = inject(TYPES.MapConfig), _dec5 = inject(TYPES.ICoordinateSystemService), _dec6 = inject(TYPES.IEventEmitter), _dec(_class = (_class2 = function () {
                ...
                return new Promise(function (resolve) {
                  ...
                  if (!amapLoaded && !mapInstance) {
                    if (token === AMAP_API_KEY) {
                      _this3.logger.warn(_this3.configService.getSceneWarninfo('MapToken'));
                    }
