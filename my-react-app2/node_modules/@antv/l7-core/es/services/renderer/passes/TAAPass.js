...
var TAAPass = (_dec = injectable(), _dec2 = inject(TYPES.IShaderModuleService), _dec3 = inject(TYPES.ILogService), _dec(_class = (_class2 = function (_BaseNormalPass) {
  ...
  function TAAPass() {
    ...
    _initializerDefineProperty(_assertThisInitialized(_this), "logger", _descriptor2, _assertThisInitialized(_this));
