...
var PixelPickingPass = (_dec = injectable(), _dec2 = inject(TYPES.ILogService), _dec(_class = (_class2 = function (_BaseNormalPass) {
...
}(BaseNormalPass), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "logger", [_dec2], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
