...
var TAAPass = (_dec = (0, _inversify.injectable)(), _dec2 = (0, _inversify.inject)(_types.TYPES.IShaderModuleService), _dec3 = (0, _inversify.inject)(_types.TYPES.ILogService), _dec(_class = (_class2 = function (_BaseNormalPass) {
  ...
  function TAAPass() {
    ...
    (0, _initializerDefineProperty2.default)((0, _assertThisInitialized2.default)(_this), "logger", _descriptor2, (0, _assertThisInitialized2.default)(_this));
