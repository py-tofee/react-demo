...
var DataMappingPlugin = (_dec = injectable(), _dec2 = inject(TYPES.IGlobalConfigService), _dec3 = inject(TYPES.ILogService), _dec4 = inject(TYPES.IMapService), _dec5 = inject(TYPES.IFontService), _dec(_class = (_class2 = function () {
  function DataMappingPlugin() {
    ...
    _initializerDefineProperty(this, "fontService", _descriptor4, this);
  }
  ...
  writable: true,
  initializer: null
}), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "mapService", [_dec4], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "fontService", [_dec5], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
